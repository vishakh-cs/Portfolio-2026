...
import proImage from "../../../public/images/vishakh-image.jpg";
            ...
            <div>
                <div className="flex-shrink-0 relative">
                    <div className="flex gap-2 items-start">
                        <div
                            className="bg-amber-300 w-24 h-24 rounded-full flex items-center justify-center overflow-hidden"
                        >
                            <Image
                                src={proImage}
                                width={96}
                                height={96}
                                alt="profile"
                                className="rounded-full object-cover w-24 h-24 hover:scale-105 transition-transform duration-300"
                            />
                        </div>
                    ...
                    <p className="text-gray-700 font-semibold text-sm leading-relaxed mt-4">
                        I’m{" "}
